                    ...
                    <div class="text-center border-primary border bg-white service-item">
                        <div class="service-content d-flex align-items-center justify-content-center p-4">
                            <div class="service-content-inner">
                                ...
                                <a href="#" class="btn btn-primary text-white px-4 py-2 my-2 btn-border-radius">En savoire plus</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="text-center border-primary border bg-white service-item">
                        <div class="service-content d-flex align-items-center justify-content-center p-4">
                            <div class="service-content-inner">
                                ...
                                <a href="#" class="btn btn-primary text-white px-4 py-2 my-2 btn-border-radius">En sovoire plus</a>
                            </div>
                        </div>
                    </div>
                </div>

...
<head>
    <meta charset="utf-8">
    <title>Contact ENC (École Nationale de Cuisine)</title>
...
<body>
    ...
    <div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s" >
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4">Contact</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item" ><a style="color: #000000" href="{{ route('accueil') }}">Accueil</a></li>
                    <li class="breadcrumb-item text-white" aria-current="page" id="contact">Contact</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="p-5 bg-light rounded" >
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    ...
                    <p class="mb-5">Pour les inscription ou toute autres information, remplissez le formulaire ci-dessous ou rejoignez-nous sur <a href="https://wa.me/2290164374858">WhatsApp Maintenant</a>.</p>
                </div>
                <div class="row g-5 mb-5">
                    ...
                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                        <div class="d-flex w-100 border border-primary p-4 rounded bg-white">
                            ...
                            <div class="">
                                <h4>Email</h4>
                                <p class="mb-2">infoplus@enc.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                        <div class="d-flex w-100 border border-primary p-4 rounded bg-white">
                            ...
                            <div class="">
                                <h4>Téléphone</h4>
                                <p class="mb-2">Tel: (+229) 64374858</p>
                            </div>
                        </div>
                    </div>
                </div>
